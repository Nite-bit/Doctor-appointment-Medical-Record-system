            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td width="15%">
                                ...
                                // $prescriptionrow = $database->query("select * from prescription where pid=$userid;");
                                // ?>
                                </p>
                            </td>
                            <td width="10%">
                                    ...
                                    <center>
                                        <table class="filter-container" style="border: none;" border="0">
                                            ...
                                            <tr>
                                             ...
                                             <td style="width: 25%;">
    <a href="prescription.php" class="non-style-link">
    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;">
        <div>
                <div class="h3-dashboard">
                    My Prescriptions
                ...
                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/icons/prescription-iceblue.svg');"></div> </div>
    </a>
</td>
                                                </tr>
                                                <tr>
