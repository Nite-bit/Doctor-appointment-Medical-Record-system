...
?>
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <a href="?action=prescribe&id='.$pid.'&name='.$name.'" class="non-style-link"><button class="btn-primary-soft btn button-icon" style="padding-left: 20px;padding-right: 20px;padding-top:12px;padding-bottom:12px;margin-top:10px;background-color:#0a76d81e;"><font class="tn-in-text">Prescribe</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
    ...
    if($_GET){
            ...
            // This logic now checks the $action variable to show the correct popup
            ...
            // *** START OF NEW POPUP LOGIC ***
                ...
                <div id="popup1" class="overlay">
                    <div class="popup" style="width: 50%;">
                        <center>
                            <a class="close" href="patient.php">&times;</a>
                            <div style="font-size: 25px; font-weight: 600; padding-bottom: 20px;">
                                Create Prescription
                            </div>
                            <div style="display: flex;justify-content: center;">
                            <table width="90%" class="sub-table scrolldown add-doc-form-container" border="0">
                                ...
                                <tr>
                                    <td>
                                        <p style="padding: 0;margin: 0;text-align: left;font-size: 18px;font-weight: 500;">Prescribe for: '.htmlspecialchars($name).'.</p><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label-td" colspan="2">
                                ...
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <textarea name="details" class="input-text" style="height:200px; resize:vertical;" placeholder="Write prescription details here..." required></textarea><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <label for="presc_date" class="form-label">Date: </label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <input type="date" name="presc_date" class="input-text" value="'.$today.'" required><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" style="padding-top: 20px;">
                                        <input type="hidden" name="pid" value="'.$id.'">
                                        <input type="submit" value="Save Prescription" class="login-btn btn-primary btn" style="width: 100%;">
                                    </td>
                                </tr>
                                </form>
                            </table>
